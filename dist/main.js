...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/actions */ \"./src/modules/actions.js\");\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n\n\n\n\nwindow.addEventListener('load', () => {\n  const tasksList = JSON.parse(localStorage.getItem('tasks')) || [];\n  const taskForm = document.getElementById('task-form');\n  const resetBtn = document.getElementById('reset-btn');\n\n  resetBtn.addEventListener('click', () => {\n    localStorage.removeItem('tasks');\n    (0,_modules_actions__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n  });\n\n  taskForm.addEventListener('submit', (e) => {\n    e.preventDefault();\n    const task = {\n      description: e.target.elements.task.value,\n      completed: false,\n      index: tasksList.length + 1,\n    };\n    tasksList.push(task);\n    localStorage.setItem('tasks', JSON.stringify(tasksList));\n    e.target.reset();\n    (0,_modules_actions__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n  });\n  (0,_modules_actions__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n});\n\n//# sourceURL=webpack://webpack-demo/./src/index.js?");
